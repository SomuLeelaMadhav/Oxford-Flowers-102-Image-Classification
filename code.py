...
# 6.1 Plot Training History (Accuracy and Loss)
...
sample_indices = np.random.choice(len(test_data), size=9, replace=False)  # Adjust the number of samples as needed

plt.figure(figsize=(12, 12))
for i, index in enumerate(sample_indices):
    plt.subplot(3, 3, i + 1)
    image, label = test_data[index][0][0], test_data[index][1][0]  # Extract image and label
